...
export default function ProductCarousel() {
  return (
    <section className="px-6 py-8">
      ...
      {/* Categorías */}
      <div className="flex mx-auto gap-4 mb-6 overflow-x-auto text-sm font-medium">
        <button className="px-4 py-2 bg-[#394eaa] text-white rounded-full">
          Favoritos
        </button>
        <button className="px-4 py-2 border rounded-full hover:bg-gray-100 flex items-center gap-3">
          Climatización
        </button>
        <button className="px-4 py-2 border rounded-full hover:bg-gray-100 flex items-center gap-3">
          Camping
        ...
        {products.map((p) => (
          <SwiperSlide key={p.id}>
            <div className="border border-gray-200 shadow-lg bg-white p-4 flex flex-col">
              ...
              {/* Botón */}
              <button className="mt-3 bg-[#394eaa] text-white py-2 rounded-lg hover:bg-green-700 flex gap-3 px-4 items-center">
                <ShoppingCart/>
